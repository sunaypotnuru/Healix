...
export default function DoctorSignUpPage() {
    ...
    return (
        <div className="min-h-screen pt-20 pb-12 px-6 bg-gradient-to-br from-[#F0F9FF] via-white to-[#E0F2FE] flex items-center justify-center relative overflow-hidden">
            {/* Floating shapes */}
            <motion.div className="absolute top-20 right-20 w-72 h-72 bg-[#0EA5E9]/5 rounded-full blur-3xl"
                animate={{ y: [0, 25, 0] }} transition={{ duration: 7, repeat: Infinity, ease: "easeInOut" }} />
            <motion.div className="absolute bottom-20 left-20 w-80 h-80 bg-[#0D9488]/5 rounded-full blur-3xl"
            ...
            >
                <Card className="p-8 shadow-2xl backdrop-blur-sm bg-white/80 border border-white/50">
                    <div className="flex flex-col items-center mb-6">
                        ...
                        <h1 className="text-3xl font-bold text-[#0F172A]">Doctor Registration</h1>
                        <p className="text-[#64748B] mt-1">Join the Netra AI medical network</p>
                    </div>
