        ...
        <Card className="p-8 shadow-2xl backdrop-blur-sm bg-white/80 border border-white/50">
              ...
              {currentStep === 1 && (
                <motion.div key="step1" initial={{ opacity: 0, x: 20 }} animate={{ opacity: 1, x: 0 }} exit={{ opacity: 0, x: -20 }} className="space-y-4">
                  <div className="space-y-2">
                    ...
                    <p className="text-sm text-[#64748B]">This language will be used for real-time translation during video consultations.</p>
                  </div>
                  <div className="space-y-2">
                  ...
                  <div className="p-4 bg-[#0D9488]/5 rounded-xl border border-[#0D9488]/20">
                    <div className="flex items-start gap-2">
                      ...
                      <p className="text-sm text-[#0F172A]/70">
                        Netra AI supports real-time translation. If your doctor speaks Hindi and you speak Bengali, the system will translate automatically during your consultation.
                      </p>
                    </div>
                  </div>
                </motion.div>
              ...
              {currentStep === 2 && (
                <motion.div key="step2" initial={{ opacity: 0, x: 20 }} animate={{ opacity: 1, x: 0 }} exit={{ opacity: 0, x: -20 }} className="space-y-4">
                  <div className="space-y-2">
                    ...
                    <textarea placeholder="e.g. Diabetes, Hypertension, Thyroid..." value={formData.medical_conditions} onChange={(e) => updateField("medical_conditions", e.target.value)} rows={2}
                  ...
                  <div className="space-y-2">
                    ...
                    <textarea placeholder="Drug allergies, food allergies..." value={formData.allergies} onChange={(e) => updateField("allergies", e.target.value)} rows={2}
                      className="w-full px-4 py-3 rounded-xl border border-gray-200 focus:border-[#0D9488] focus:outline-none focus:ring-2 focus:ring-[#0D9488]/20 transition-all resize-none bg-[#F8FAFC]" />
                  </div>
                  <div className="space-y-2">
                    <Label>Current Medications</Label>
                    <textarea placeholder="List any medications you're currently taking..." value={formData.current_medications} onChange={(e) => updateField("current_medications", e.target.value)} rows={2}
                      className="w-full px-4 py-3 rounded-xl border border-gray-200 focus:border-[#0D9488] focus:outline-none focus:ring-2 focus:ring-[#0D9488]/20 transition-all resize-none bg-[#F8FAFC]" />
                  </div>
                  <div className="p-4 bg-[#0D9488]/5 rounded-xl border border-[#0D9488]/20">
                    <p className="text-sm text-[#0F172A]/70">
                      This information will be securely shared with your doctor when you book a consultation, so they can be prepared beforehand.
                    </p>
                  </div>
                </motion.div>
              )}
          ...
          <div className="mt-6 text-center">
            <p className="text-sm text-[#64748B]">
              ...
              <Link to="/login/patient" className="text-[#0D9488] font-semibold hover:underline">Sign in</Link>
            </p>
          </div>
        </Card>
      </motion.div>
