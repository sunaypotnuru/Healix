      ...
      <div className="max-w-4xl mx-auto px-6 lg:px-12">
        ...
        >
          ...
          <p className="text-lg text-gray-600">
            AI-powered detection results with confidence score
          </p>
        </motion.div>
          ...
          <div className="p-8 space-y-6">
            ...
            <div className="flex items-center justify-between p-6 bg-[#F8F9FA] rounded-2xl">
              <div className="flex items-center gap-4">
                ...
                <div>
                  <p className="text-sm text-gray-600">Estimated Hemoglobin Level</p>
        ...
        >
          <p className="text-sm text-yellow-800 text-center">
            <strong>Disclaimer:</strong> This is an AI-powered screening tool and should not replace professional medical diagnosis. Please consult with a qualified healthcare provider for accurate diagnosis and treatment.
          </p>
        </motion.div>
      </div>
    </section>
