      ...
      <div className="relative max-w-7xl mx-auto px-6 lg:px-12 py-12">
        <div className="grid lg:grid-cols-2 gap-12 items-center min-h-[calc(85vh-160px)]">
          ...
          <div className="z-10 hero-fade-in">
            ...
            {/* Heading */}
            <h1 className="text-5xl lg:text-6xl font-bold mb-6 leading-tight text-[#0F172A] hero-slide-up" style={{ animationDelay: '0.2s' }}>
              AI-Powered
              <br />
            ...
            <p className="text-lg lg:text-xl mb-8 text-[#0F172A]/70 leading-relaxed max-w-lg hero-slide-up" style={{ animationDelay: '0.3s' }}>
              Smart medical screening begins with care. Experience non-invasive
              anemia detection through advanced conjunctiva analysis.
            </p>

            {/* Buttons */}
            <div className="flex flex-wrap gap-4 hero-slide-up" style={{ animationDelay: '0.4s' }}>
              <Button
                size="lg"
                onClick={() => navigate("/login")}
                className="bg-gradient-to-r from-[#0D9488] to-[#0F766E] text-white font-semibold px-8 py-6 text-lg shadow-xl hover:shadow-2xl transition-all duration-300 hover:scale-105"
              >
