      ...
      <div className="relative max-w-7xl mx-auto px-6 lg:px-12 pt-32 pb-20">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            >
              Upload conjunctiva image and get instant AI-powered anemia
              screening. Fast, accurate, and non-invasive detection.
            </motion.p>
            <motion.div
              initial={{ opacity: 0, y: 20 }}
              animate={{ opacity: 1, y: 0 }}
            ...
            >
              ...
              <div>
                ...
                <div className="text-sm text-white/80">Scans Done</div>
              </div>
              <div>
