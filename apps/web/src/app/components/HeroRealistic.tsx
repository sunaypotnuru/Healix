        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            >
              ...
              <span className="text-sm font-semibold">AI-Powered Medical Technology</span>
            </motion.div>
            ...
            >
              Advanced medical screening using conjunctiva analysis. Non-invasive, 
              instant results powered by cutting-edge artificial intelligence.
            </motion.p>
            <motion.div
              initial={{ opacity: 0, y: 20 }}
              animate={{ opacity: 1, y: 0 }}
            ...
            <div className="relative w-full max-w-lg">
              ...
              >
                <div className="flex items-center gap-2 mb-2">
                  ...
                  <span className="text-xs text-white/80 font-semibold">Live Monitoring</span>
                </div>
